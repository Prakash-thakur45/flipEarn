...
import { BadgeCheck, BadgeIcon, LineChart, MapPin, User } from "lucide-react";
    ...
    >
      ...
      {listing.featured && (
        <>
          <p className="py-1" />
          <div
            className=" absolute top-0 left-0 w-full bg-linear-to-r from-pink-500 
                                   to-purple-500 text-white text-center text-xs font-semibold
                                   py-1 tracking-wide uppercase "
          >
            Featured
          </div>
        </>
      ...
      <div className="p-5 ">
        ...
        <div className="flex items-center gap-3 mb-3">
          <span
            className="text-xs font-medium bg-pink-100 text-pink-600 px-3
